...
(def one'   #(partial #(%1 %2) %))
(def two'   #(% (partial #(%1 %2) %)))
(def three' #(% (% (partial #(%1 %2) %))))
(def four'  #(% (% (% (partial #(%1 %2) %)))))
(def five'  #(% (% (% (% (partial #(%1 %2) %))))))
(def six'   #(% (% (% (% (% (partial #(%1 %2) %)))))))
(def seven' #(% (% (% (% (% (% (partial #(%1 %2) %))))))))
(def eight' #(% (% (% (% (% (% (% (partial #(%1 %2) %)))))))))
(def nine'  #(% (% (% (% (% (% (% (% (partial #(%1 %2) %))))))))))
...
;; (def zero''  (fn-> (str %1)))            ;; prints as 1
(def zero''  (fn-> (partial (str %2) %1)))
(def one''   (fn-> (%1 %2)))
(def two''   (fn-> (%1 (%1 %2))))
